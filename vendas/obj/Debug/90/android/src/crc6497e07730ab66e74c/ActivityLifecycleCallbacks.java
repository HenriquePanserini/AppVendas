...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Acr.Support.Android.ActivityLifecycleCallbacks, Acr.Support.Android", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class) {
			mono.android.TypeManager.Activate ("Acr.Support.Android.ActivityLifecycleCallbacks, Acr.Support.Android", "", this, new java.lang.Object[] {  });
		}
	}
