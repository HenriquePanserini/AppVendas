...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("vendas.at_rel_menu, vendas", at_rel_menu.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == at_rel_menu.class) {
			mono.android.TypeManager.Activate ("vendas.at_rel_menu, vendas", "", this, new java.lang.Object[] {  });
		}
	}
