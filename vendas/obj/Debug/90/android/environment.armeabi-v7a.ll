; ModuleID = 'obj\Debug\90\android\environment.armeabi-v7a.ll'
source_filename = "obj\Debug\90\android\environment.armeabi-v7a.ll"
...
@__DSOCacheEntry_name.7 = internal constant [22 x i8] c"libsqlite3_xamarin.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 10
	%struct.DSOCacheEntry {
		i64 1548573729, ; hash 0x5c4d5c21, from name: libsqlite3_xamarin
		i8 0, ; ignore
	...
	; 12
	%struct.DSOCacheEntry {
		i64 1816163972, ; hash 0x6c407684, from name: sqlite3_xamarin
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 21
	%struct.DSOCacheEntry {
		i64 3269127472, ; hash 0xc2daed30, from name: sqlite3_xamarin.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 31
	%struct.DSOCacheEntry {
		i64 4233077776, ; hash 0xfc4fa410, from name: libsqlite3_xamarin.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}
