; ModuleID = 'obj\Debug\90\android\environment.arm64-v8a.ll'
source_filename = "obj\Debug\90\android\environment.arm64-v8a.ll"
...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"10d09524-f35f-4ed1-a5df-08a755a4f767\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [14 x i8] c"vendas.vendas\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33559300, ; android_runtime_jnienv_class_token
	i32 100753959, ; jnienv_initialize_method_token
	i32 100753958, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.8 = internal constant [22 x i8] c"libsqlite3_xamarin.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 23
	%struct.DSOCacheEntry {
		i64 15959642688342191966, ; hash 0xdd7c0a779ccbef5e, from name: sqlite3_xamarin
		i8 0, ; ignore
	...
	; 25
	%struct.DSOCacheEntry {
		i64 16238552145552505530, ; hash 0xe15aed240e507aba, from name: libsqlite3_xamarin.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 28
	%struct.DSOCacheEntry {
		i64 16839724782171795185, ; hash 0xe9b2b877fcb12ef1, from name: libsqlite3_xamarin
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 29
	%struct.DSOCacheEntry {
		i64 17717413663021683106, ; hash 0xf5e0e5db0b0f51a2, from name: sqlite3_xamarin.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
