...
namespace vendas
{
    [Activity(Label = "at_detalheproduto")]
    public class at_detalheproduto : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.layout_detalheproduto);
        ...
        private void Btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            string xy1x = "";
            xy1x = unitario.Text.ToString(); //.Substring(1, unitario.Text.Length );

            if ((unitario.Text == "") || (unitario.Text == "0") || (unitario.Text == null) || (quantidade.Text == "0") || (quantidade.Text == null) || (quantidade.Text == ""))
            {
                Toast.MakeText(this, " Digite quantidade ou valor!!! ", ToastLength.Short).Show();
            }
            else
            {
        ...
        private void Desconto_TextChanged(object sender, Android.Text.TextChangedEventArgs e)
        {
            ...
            if ((xy1x != "") && (unitario.Text != "") && (xy1x != null) && (unitario.Text != null) && (desconto.Text != null) && (desconto.Text != "") && (quantidade.Text != null) && (quantidade.Text != ""))
            {
                ...
                string xyw = desconto.Text.ToString();   //.Substring(3, desconto.Text.Length - 3);
                xyw = xyw.Replace(".", ",");
                decimal xxdesconto = Math.Round(Convert.ToDecimal(xyw), 2);

                if (xxdesconto <= vars.descontovendedor)
                {
                    passar = 1;
                }
                else
                ...
                if (vars.descontoprod > 0 && xxdesconto <= vars.descontoprod  )
                {
                    passar2 = 1;
                }
                else
               ...
               // else
              //  {
              //      Toast.MakeText(this, " Desconto mao permitido!!! ", ToastLength.Long).Show();
              //  }
            }
        }
